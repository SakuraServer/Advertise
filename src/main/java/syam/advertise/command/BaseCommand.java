...
import syam.advertise.ConfigurationManager;
...
public abstract class BaseCommand {
    // Logger
    protected static final Logger log = Advertise.log;
    protected static final String logPrefix = Advertise.logPrefix;
    protected static final String msgPrefix = Advertise.msgPrefix;
    /* コマンド関係 */
